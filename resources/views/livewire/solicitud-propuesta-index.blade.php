<div>
    <div class="card">
        ...
        <div class="card-header">
            <td width="10px"> <a class="btn btn-primary" href="{{ route('solicitud_propuestas.create') }}">Crear</a></td>
        </div>
                        ...
                        @foreach ($solicitud_propuestas as $solicitud_propuesta)
                            ...
                            <tr>
                                ...
                                <td width="10px"> <a class="btn btn btn-info btn-sm"
                                        href="{{ route('solicitud_propuestas.show', $solicitud_propuesta->id) }}">Mostrar</a></td>
                                <td width="10px"> <a class="btn btn btn-secondary btn-sm"
                                        href="{{ route('solicitud_propuestas.edit', $solicitud_propuesta->id) }}">Editar</a></td>
                                {{-- <td width="10px">
