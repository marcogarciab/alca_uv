...
@section('content')
    ...
    {!! Form::model($cliente, ['route' => ['clientes.index', $cliente], 'method' => 'get']) !!}
            ...
            <div class="row gutters">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('nombre', null, ['class' => 'form-control', 'placeholder' => 'Inserte Nombre de Cliente', 'disabled']) !!}
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('apellido_paterno', null, ['class' => 'form-control', 'placeholder' => 'Inserte Apellido Paterno de Cliente', 'disabled']) !!}
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('apellido_materno', null, ['class' => 'form-control', 'placeholder' => 'Inserte Apellido Materno de Cliente', 'disabled']) !!}
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('telefono', null, ['class' => 'form-control', 'placeholder' => 'Inserte Teléfono de Cliente', 'disabled']) !!}
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        ...
                        {!! Form::date('fecha_nacimiento', $cliente->fecha_nacimiento, ['class' => 'form-control', 'placeholder' => 'Inserte Fecha Nacimiento de Cliente', 'disabled']) !!}
                    </div>
